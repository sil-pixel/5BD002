...
```{r}
phe <- fread("~/Documents/GitHub/5BD002/gwas_exercises/GWAS_2/ICAM2/ICAM2_sample.fam",
             select = c(2,6), header = FALSE, col.names = c("IID", "ICAM2"))
ggplot(phe, aes(ICAM2)) + geom_histogram(binwidth=0.15)
```
